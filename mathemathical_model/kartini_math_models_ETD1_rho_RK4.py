...
def fung_rho_update_RK4(rho_n, t_n, dt, x_n, v, rho_max, H):
    ...
    k2 = fung_rho(rho_n + dt/2, t_n + dt/2, x_n, v, rho_max, H)
    k3 = fung_rho(rho_n + dt/2, t_n + dt/2, x_n, v, rho_max, H)
    k4 = fung_rho(rho_n + dt, t_n + dt, x_n, v, rho_max, H)
