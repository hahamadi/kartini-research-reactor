...
def run_simulation_prke(H=H, rho_max=rho_max, v_percent=v_percent, pos_x_percent=pos_x_percent, 
                        t_end=t_end, dt=dt, Lambda=Lambda, rho_polynomial=rho_polynomial):
