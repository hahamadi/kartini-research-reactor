...
import polynom_solution_etd1 as pse
import sinkuadrat_solution_etd1V2 as sse
#import sigmoid_solution_etd1V2 as sigse
#import gaussbell_solution_etd1 as gse

case = {
    "polynomETD1": [pse.run_simulation_prke, rho_polynomial],
    "sin2ETD1": [sse.run_simulation_prke, drho_dx_sin2],
    "sigmoidETD1": [sse.run_simulation_prke, drho_dx_sigmoid],
    "gaussETD1": [sse.run_simulation_prke, drho_dx_gauss]
}
